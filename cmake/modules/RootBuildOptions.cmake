...
foreach(opt afdsmgrd afs alien bonjour castor chirp cxx11 cxx14 cxx17 geocad gfal glite globus gsl_shared hdfs ios
        jemalloc krb5 ldap memstat monalisa pyroot_legacy qt qtgsi rfio ruby sapdb srp tcmalloc python xproofd)
  if(${opt})
...
#---Deprecated options------------------------------------------------------------------------
foreach(opt vmc table cxxmodules exceptions oracle pythia6 pythia6_nolink pyroot-python2 minuit2)
  if(${opt})
